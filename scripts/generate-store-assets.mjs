...
const locales = {
  en: {
    ...
    scenes: {
      ...
      confirm: {
        ...
        subtitle: 'Detected form submissions always ask',
        user: 'Submit the checkout form',
        title: '🔒 Confirm form submission',
        body: 'Submit 3 fields to shop.example/checkout.',
        approve: 'Submit form',
        deny: 'Deny',
        hint: ['Known actions run automatically.', 'Every detected submission asks separately.'],
      },
      attachments: {
  ...
  'zh-CN': {
    ...
    scenes: {
      ...
      confirm: {
        headline: '表单提交由你确认',
        subtitle: '检测到的表单提交每次都问',
        user: '提交结账表单',
        title: '🔒 请确认表单提交',
        body: '向 shop.example/checkout 提交 3 个字段。',
        approve: '确认提交',
        deny: '拒绝',
        hint: ['已知操作会自动执行。', '检测到的提交会逐次确认。'],
      },
      attachments: {
        headline: '结合网页与文件提问',
