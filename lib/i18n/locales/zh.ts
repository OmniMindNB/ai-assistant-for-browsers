export const zh = {
  ...
  'privacy.pageDataBody': '你发送的网页内容、截图和对话内容可能会发送给你配置的 AI Provider。',
  'privacy.localDataTitle': '数据保留在本机',
  'privacy.localDataBody': '你的 API Key、设置和对话历史仅保存在本机。',
  'privacy.noBackendTitle': '没有 Aluminum 后端或分析服务',
  'privacy.noBackendBody': 'Aluminum 不运营后端服务，也不会收集分析数据。',
