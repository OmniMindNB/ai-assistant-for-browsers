...
export const en: Record<keyof typeof zh, string> = {
  ...
  'privacy.pageDataBody': 'Page content, screenshots, and conversations you send may go to your configured AI provider.',
  'privacy.localDataTitle': 'Your data stays local',
  'privacy.localDataBody': 'Your API keys, settings, and conversation history stay on this device.',
  'privacy.noBackendTitle': 'No Aluminum backend or analytics',
  'privacy.noBackendBody': 'Aluminum operates no backend service and collects no analytics.',
