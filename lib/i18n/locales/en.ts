...
export const en: Record<keyof typeof zh, string> = {
  ...
  // Result counts shown at the right edge of a step
  'agentActivity.note.results': '{count} results',
  'agentActivity.note.resultsTruncated': '{count}+ results',
  'agentActivity.note.fields': '{count} fields',
  'agentActivity.note.tabs': '{count} tabs',
  'agentActivity.note.filled': '{ok}/{total} written',
  // Collapsed header: category names and the summary sentence
  'agentActivity.category.read': 'Read the page',
  'agentActivity.category.screenshot': 'Took screenshots',
  'agentActivity.category.write': 'Changed the page',
  'agentActivity.category.interact': 'Used controls',
  'agentActivity.category.navigate': 'Navigated',
  'agentActivity.category.wait': 'Waited for the page',
  'agentActivity.category.ask': 'Asked you',
  'agentActivity.category.report': 'Reported the outcome',
  'agentActivity.summary.line': '{categories} — {count} steps',
  'agentActivity.summary.countOnly': '{count} steps',
  'agentActivity.summary.running': 'Working — {count} steps so far',
  'agentActivity.summary.separator': ', ',
  'agentActivity.summary.expand': 'Show execution steps',
  'agentActivity.summary.collapse': 'Hide execution steps',
